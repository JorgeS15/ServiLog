...
> Self-hosted service log for machines and agricultural equipment — v1.7.1
...
| **Session cookies** | `HttpOnly; SameSite=Strict` — inaccessible to JavaScript and not sent on cross-site requests |
